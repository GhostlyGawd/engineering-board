...
- Terminal action: `keep-open` until implementation merged-main evidence passes;
  then resolve B068 in a closeout change and verify the closeout merged-main run
