...
| Product behavior | Required | The rewrite preserves commands, states, permissions, and boundaries | Full suite: 15 groups passed and 1 bundle-checksum group failed | Current product documentation | Product behavior passed; versioned bundle work is open |
