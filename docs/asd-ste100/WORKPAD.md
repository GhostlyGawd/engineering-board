...
| Release preparation | Required | One script updates the changelog, versions, bundle URL, and checksum | Release-preparation suite: 7 checks passed | `docs/RELEASING.md` and maintainer skill | Worker validation passed |
