...
2. Note the size of `docs/boards/<project>/_sessions/<session-id>.md` (if it exists. if not, that is also fine).
...
- The line appears even when `_sessions/` is empty or does not exist.
