...
#
# Sub-tests (in order):
#   1. command-frontmatter.sh                 — /pm-start, /worker-start, /board-pause, /board-resume markdown lint
...
#   6. mode-transition-guard.sh               — board-mode-guard.sh refusal-matrix enforcement (v0.3.1)
#
...
#
# Exits 0 iff all 6 sub-tests pass.
