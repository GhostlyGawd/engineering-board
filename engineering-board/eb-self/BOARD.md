...
- B077 P2 | [Codex exec cancels read-only board tools while MCP schemas omit approval annotations](bugs/B077-codex-exec-cancels-read-only-board-tools-while-mcp-schemas.md)
