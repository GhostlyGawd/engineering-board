...
- F006 P2 | [Build the free-only Codex design canary fixture pack](features/F006-build-the-free-only-codex-design-canary-fixture-pack.md) (in_progress)
...
- O004 | [Codex design tooling needs lane-specific evaluation rather than one plugin leaderboard](observations/O004-codex-design-tooling-needs-lane-specific-evaluation-rather-t.md)
